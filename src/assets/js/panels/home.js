...
class Home {
    ...
    async startGame() {
        ...
        ipcRenderer.send('new-status-discord-jugando',  `Jugando a '${options.name}'`) // Notas: debido a la V2 las versiones de "Fabric" no se mostraban en discord, este cambio lo soluciona.
        ...
        launch.on('data', (e) => {
            ...
            ipcRenderer.send('main-window-progress-load')
            infoStarting.innerHTML = `JUGANDO '${options.name}'`
            console.log(e);
